...
void CFiguras::prisma(float altura, float largo, float profundidad, GLuint text_fre, GLuint text_der, GLuint text_izq, GLuint text_atr, GLuint text_arr, GLuint text_aba)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, text_fre);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
		//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	...
	glBindTexture(GL_TEXTURE_2D, text_der);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Right
		//glColor3f(0.0,0.0,1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	...
	glBindTexture(GL_TEXTURE_2D, text_atr);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Back
		//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	...
	glBindTexture(GL_TEXTURE_2D, text_izq);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Left
		//glColor3f(1.0,1.0,1.0);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glBindTexture(GL_TEXTURE_2D, text_aba);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Bottom
		//glColor3f(0.4,0.2,0.6);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
...
void CFiguras::prisma(float altura, float largo, float profundidad, GLuint text, int sup, int inf)  //Funcion creacion prisma
{
...
void CFiguras::skybox(float altura, float largo, float profundidad, GLuint text_abajo, GLuint text_arriba, GLuint text_izquierda, GLuint text_derecha, GLuint text_frente, GLuint text_atras)
{
	GLfloat vertice[8][3] = {
				{0.5*largo ,-0.5*altura, 0.5*profundidad},    //Coordenadas Vértice 1 V1
				{-0.5*largo ,-0.5*altura , 0.5*profundidad},    //Coordenadas Vértice 2 V2
	...
	glBindTexture(GL_TEXTURE_2D, text_frente);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front
		//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	...
	glBindTexture(GL_TEXTURE_2D, text_derecha);   // choose the texture to use.
	...
	glBindTexture(GL_TEXTURE_2D, text_atras);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Back
		//glColor3f(0.0,1.0,0.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	...
	glBindTexture(GL_TEXTURE_2D, text_izquierda);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Left
		//glColor3f(1.0,1.0,1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	...
	glBindTexture(GL_TEXTURE_2D, text_abajo);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Bottom
		//glColor3f(0.4,0.2,0.6);
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[0]);
